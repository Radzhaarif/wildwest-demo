...
- `src/map-module.js` - фасад карты: загрузка сессии, экран карты, обработка событий, вход в бой, HUD и верхние кнопки. После START заранее прогревает код боевого модуля, чтобы первый клик по battle-точке не ждал загрузку и парсинг battle JS.
