...
- `src/asset-preloader.js` - общий предзагрузчик локальных ассетов из `data/Assets`; используется стартовым экраном загрузки и прогревом ассетов кампании перед START.
